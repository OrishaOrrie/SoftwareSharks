...
**User Manual** : [User Manual](https://www.overleaf.com/read/qxxgtmyrpkhy) \
**Coding Guidelines** : [Coding Guidelines](https://www.overleaf.com/read/dzbcvjzrbfhq) \
**Requirements & Other Documentation** : [Documentation on GitHub](https://github.com/OrishaOrrie/SoftwareSharks/tree/master/Documentation)

...
export declare const INITIAL_REDUCER: InjectionToken<any>;
export declare const INITIAL_STATE: InjectionToken<any>;
export declare const _INITIAL_REDUCER: InjectionToken<any>;
export declare const _INITIAL_STATE: InjectionToken<any>;
